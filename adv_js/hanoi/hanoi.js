function randomColor() {
    return '#' + Math.random().toString(16).substr(-6) /* luam doar primele 6 caractere */
}
...
class Rod {
    ...
    canPutDisk(disk) {
        return this.isEmpty()
               this.topDisk().biggerThan(disk) /* ultimul disc e mai mare decat discul pe care vrem sa il punem pe tija */
    }
    pop() {
